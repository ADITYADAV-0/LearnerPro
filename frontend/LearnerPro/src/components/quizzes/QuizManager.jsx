        ...
        if(quizzes.length === 0){
            return (
                <EmptyState
                 ...
                 discription="Generate a quiz from your document to test your knowledge."
                />
            );
        }
        ...
        >
            <div className="space-y-4">
                <p className='text-sm text-neutral-600'>
                    Are you sure you to delete the quiz: <span className='font-semibold text-neutral-900'>{selectedQuiz?.title || 'this quiz'}</span>? This action cannot be undone.
                </p>
                <div className="flex justify-end gap-2 pt-2">
                    <Button
                         type='button'
