      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='flex items-center justify-between mb-10'>
          <div>
            ...
            <p className='text-slate-500 text-sm'>Manage and Organize your learing materials</p>
          </div>
        ...
        <div className='relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8'>
          ...
          <form onSubmit={handleUpload} className='space-y-5'>
            ...
            <div className='space-y-2'>
              ...
              <div className='relative border border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200'>
                <input
                 id='file-upload'
                 type='file'
